...
/**
 * The class of the command for editing personal data by the client
 */
public class PersonalDataCommand implements ICommand {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (request.getParameter("name_phone_asc") != null) {
            telephoneTariffs.sort(Comparator.comparing(Tariff::getName));
            forward = Path.PAGE_ACCOUNT;
        }
        if (request.getParameter("name_phone_desc") != null) {
            telephoneTariffs.sort((o1, o2) -> o2.getName().compareTo(o1.getName()));
            forward = Path.PAGE_ACCOUNT;
        }
        ...
        if (request.getParameter("price_phone_desc") != null) {
            telephoneTariffs.sort((o1, o2) -> Double.compare(o2.getPrice(), o1.getPrice()));
            forward = Path.PAGE_ACCOUNT;
        }

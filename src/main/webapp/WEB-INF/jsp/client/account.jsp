                                    ...
                                    <div class="col">
                                        <div class="d-flex justify-content-end">
                                            ...
                                            <button type="button" class="btn btn-outline-secondary btn-sm mr-2"
                                                ...
                                                <fmt:message
                                                        key="account.menu.private_office.modal.balancewallet"/>
                            ...
                            <div class="col">
                                <table class="table table-hover mt-2">
                                    ...
                                    <c:forEach var="tariff" items="${fullUser.tariffs}">
                                        <tr>
                                            <td>${tariff.name}</td>
                                            <td><fmt:formatNumber value="${tariff.price}" type="currency" minFractionDigits="2" maxFractionDigits="2" currencySymbol="₴" /></td>
                                                ...
                                                <form action="controller?action=account" method="post">
                                                    ...
                                                    <div class="d-flex justify-content-end">
                                                        <button type="submit" class="btn btn-outline-secondary btn-sm">
                                                            <fmt:message key="profile.modal.toPDF"/>
                                                ...
                                                <c:forEach var="inetTariff" items="${internetTariffs}">
                                                    ...
                                                    <c:if test="${count==0}">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex justify-content-center">
                                                                    <fmt:formatNumber value="${inetTariff.price}" type="currency" minFractionDigits="2" maxFractionDigits="2" currencySymbol="₴" />
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="d-flex justify-content-start">
                                        ...
                                        <div class="card card-body">
                                            ...
                                            <table class="table table-hover mt-2">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex justify-content-center">
                                                            <fmt:formatNumber value="${iptvTariff.price}" type="currency" minFractionDigits="2" maxFractionDigits="2" currencySymbol="₴" />
                                                       </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex justify-content-start">
                                        ...
                                        <div class="card card-body">
                                            ...
                                            <table class="table table-hover mt-2">
                                                ...
                                                <c:forEach var="phoneTariff" items="${telephoneTariffs}">
                                                    <c:set var="count" value="0"/>
                                                    <c:forEach var="userTariffs" items="${fullUser.tariffs}">
                                                        <c:if test="${userTariffs.id == phoneTariff.id}">
                                                            <c:set var="count" value="1"/>
                                                        </c:if>
                                                    </c:forEach>
                                                    <c:if test="${count==0}">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex justify-content-center">
                                                                    <fmt:formatNumber value="${phoneTariff.price}" type="currency" minFractionDigits="2" maxFractionDigits="2" currencySymbol="₴" />
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="d-flex justify-content-start">
                                                                        ${phoneTariff.description}
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="d-flex justify-content-end">

                            ...
                            <div class="tab-content" id="myTabContent">
                                    ...
                                    <table class="table table-hover mt-2">
                                        ...
                                        <c:forEach var="intTariff" items="${internetTariffs}">
                                            <tr>
                                                ...
                                                <td><fmt:formatNumber value="${intTariff.price}" type="currency" minFractionDigits="2" maxFractionDigits="2" currencySymbol="₴" /></td>
                                ...
                                <div class="tab-pane fade" id="iptv" role="tabpanel" aria-labelledby="iptv-tab">
                                    <table class="table table-hover mt-2">
                                        ...
                                        <tr>
                                            ...
                                            <td><fmt:formatNumber value="${iptvTariff.price}" type="currency" minFractionDigits="2" maxFractionDigits="2" currencySymbol="₴" /></td>
                                ...
                                <div class="tab-pane fade" id="telephony" role="tabpanel"
                                    ...
                                    <table class="table table-hover mt-2">
                                        ...
                                        <tbody>
                                        <c:forEach var="phoneTariff" items="${telephoneTariffs}">
                                            <tr>
                                                <td>${phoneTariff.name}</td>
                                                <td><fmt:formatNumber value="${phoneTariff.price}" type="currency" minFractionDigits="2" maxFractionDigits="2" currencySymbol="₴" /></td>
                                                        ...
                                                        <div>
                                                            <form action="controller?action=edit_client"
                                                                ...
                                                                <button type="submit"
                                                                        class="btn btn-outline-secondary btn-sm"
                                                                        name="btnLock">
                                                                        ${fullUser.blocked ? '<i class="material-icons">unlock</i>' : '<i class="material-icons">lock</i>'}
                                                                </button>
                                                            </form>
                                                        </div>
                                                        <div class="ml-1">
                                                            <form method="post" action="controller?action=profile">
                                                                ...
                                                                <button type="submit"
                                                                        class="btn btn-outline-secondary btn-sm">
                                                                    <fmt:message key="table.th.detail"/>
                                                                    <i class="material-icons"></i>
                                                                </button>
                                                            </form>
                                                        </div>
                                    ...
                                    <form class="mt-2" method="post" action="controller?action=registration">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="flex-fill ml-1">
                                                    <label for="password">
                                                        <fmt:message key="profile.modal.label.password"/>
                                                    </label>
                                                    <input type="tel" class="form-control" id="password" name="password"
                                                           placeholder="<fmt:message key="profile.modal.placeholder.password"/>"
                                                    ...
                                                    <div class="card card-body">
                                                        ...
                                                        <table class="table table-hover mt-2">
                                                            ...
                                                            <c:forEach var="fullUser" items="${internetTariffs}">
                                                                <tr>
                                                                    <td>${fullUser.name}</td>
                                                                    <td><fmt:formatNumber value="${fullUser.price}" type="currency" minFractionDigits="2" maxFractionDigits="2" currencySymbol="₴" /></td>
                                                ...
                                                <div class="collapse mt-2" id="collapse-phone-tariff">
                                                    <div class="card card-body">
                                                        ...
                                                        <table class="table table-hover mt-2">
                                                            ...
                                                            <tbody>
                                                            <c:forEach var="fullUser" items="${telephoneTariffs}">
                                                                <tr>
                                                                    <td>${fullUser.name}</td>
                                                                    <td><fmt:formatNumber value="${fullUser.price}" type="currency" minFractionDigits="2" maxFractionDigits="2" currencySymbol="₴" /></td>
                                                                    <td>${fullUser.description}</td>

        ...
        <div class="d-flex justify-content-start">
            <form method="post" action="controller?action=main">
                ...
                <button type="submit"
                        ...
                        <fmt:message key="profile.modal.home"/>
            ...
            <div class="pl-1">
                <button type="submit"
                        ...
                        <fmt:message key="main.modal.button.edit"/>
                    <i class="material-icons"></i>
                </button>
                <!-- Modal -->
        ...
        <div class="card border-dark p-2 m-0 mt-2">
            <div class="d-flex justify-content-center">
                <p class="text-uppercase font-weight-bold">
                    <fmt:message key="profile.title.contract"/> № ${fullUser.account.number}
                </p>
            </div>
